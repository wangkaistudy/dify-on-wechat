...
class Query:
    ...
    def POST(self):
        ...
        if gewechat_msg.from_user_id==gewechat_msg.to_user_id:
            gewechat_msg.actual_user_id=""
            logger.debug(f"[gewechat] from_user_id==from_user_id: {gewechat_msg.from_user_id}: {gewechat_msg.to_user_id}")
